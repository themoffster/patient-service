...
insert into patient (id, firstname, lastname, dob, sex) values ('67150f64-b235-4e07-af6b-4018aabc1e3e', 'Joe', 'Bloggs', '2010-01-01', 'M');

insert into guardian (id, firstname, lastname, dob, sex, patient_id, relation_id, contact_details_id) values ('72181737-7c07-4183-8f1c-9a181eec3006', 'Jane', 'Bloggs', '1980-06-01', 'F', '67150f64-b235-4e07-af6b-4018aabc1e3e', 1, '841646d2-e6a6-4be2-a014-674bb65aefcd');
